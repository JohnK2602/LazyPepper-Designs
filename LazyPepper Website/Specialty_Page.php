...
$sql = "SELECT inventory.item_id, inventory.item_img, inventory.length, inventory.width, inventory.height, inventory.wood_type, inventory.price, inventory.item_type
            FROM inventory
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ps-3 ">
                    ...
                    <li class="nav-item me-4">
                        <a class="nav-link active" aria-current="page" href="Specialty_Page.php" tabindex="-1" aria-disabled="true">Specialty</a>
                    </li>
                    <li class="nav-item me-4">
                    ...
                    <div class="card">
                        <div class="card-body align-content-center text-align-start">
                            ...
                            <p>
                                ...
                                <br>
                                <?php echo "Width: ",$row['width'],"in."; ?>
                                <br>
                                <?php echo "Height: ",$row['height'],"in."; ?>
                                <br>
